...
import com.ibanity.client.exceptions.InvalidDefaultHttpHeaderForSignatureException;
import com.ibanity.client.exceptions.SignatureException;
...
public class IBanitySignatureInterceptor implements HttpRequestInterceptor {
    ...
    private void setDefaultHttpHeaderValues(HttpRequest httpRequest, byte[] body) throws com.ibanity.client.exceptions.DigestException {
    ...
    private void setDigestHeader(HttpRequest httpRequest, byte[] body) throws com.ibanity.client.exceptions.DigestException {
        String digestValue;
        try {
            ...
            throw new com.ibanity.client.exceptions.DigestException(errorMessage, e);
        }
    }

    private void setSignatureHeader(HttpRequest httpRequest, byte[] body) throws com.ibanity.client.exceptions.SignatureException {
        HttpRequestWrapper requestWrapper = (HttpRequestWrapper) httpRequest;
    ...
    private String generateSignature(HttpRequestWrapper requestWrapper, String signatureHeaders) throws com.ibanity.client.exceptions.SignatureException {
        try {
            ...
            LOGGER.fatal(errorMessage, e);
            throw new com.ibanity.client.exceptions.SignatureException(errorMessage, e);
        }
    }

    private String getSignatureAlgorithm(boolean forAlgorithmHeader) throws com.ibanity.client.exceptions.SignatureException {
