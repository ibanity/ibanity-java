...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction find(TransactionReadQuery transactionReadQuery) {
        URI uri = buildUri(getUrl(transactionReadQuery.getAccountId(), null)
                + "/"
    ...
    public IbanityCollection<Transaction> list(TransactionsReadQuery transactionsReadQuery) {
        ...
        URI uri = buildUri(getUrl(transactionsReadQuery.getAccountId(), transactionsReadQuery.getSynchronizationId()), pagingSpec);
    ...
    private String getUrl(UUID accountId, UUID synchronizationId) {
        String url;
