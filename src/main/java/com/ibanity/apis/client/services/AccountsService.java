...
public interface AccountsService {
    ...
    /**
     * Create a new sandbox Account in the sandbox financial institution, linked to the provide sandbox user
     * @param customerAccessToken the token generated by the call to the corresponding service (See @link com.ibanity.services.CustomerAccessTokenService#createCustomerAccessToken(CustomerAccessToken)}
     ...
     * @param sandboxAccount the Financial Institution Sandbox Account to be created
     * @return the created version of the sandbox Account
     */
    FinancialInstitutionAccount createSandBoxAccount(CustomerAccessToken customerAccessToken, UUID financialInstitutionId, UUID financialInstitutionUserId, FinancialInstitutionAccount sandboxAccount);

    /**
     *
     * @param customerAccessToken the token generated by the call to the corresponding service (See @link com.ibanity.services.CustomerAccessTokenService#createCustomerAccessToken(CustomerAccessToken)}
     * @param financialInstitutionId The Id Sandbox Financial Institution in which we want to create a new account linked to the provide financialInstitutionUserId
     * @param financialInstitutionUserId The Id of the Sandbox User for which we want to delete the Sandbox Account
     * @param sandboxAccountId the ID of the Financial Institution Sandbox Account to be deleted
     */
    void deleteSandBoxAccount(CustomerAccessToken customerAccessToken, UUID financialInstitutionId, UUID financialInstitutionUserId, UUID sandboxAccountId);
}
