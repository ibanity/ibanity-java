...
public class FinancialInstitutionAccountsServiceImpl extends AbstractServiceImpl implements FinancialInstitutionAccountsService {
    ...
    @Override
    public FinancialInstitutionAccount getFinancialInstitutionAccount(final UUID financialInstitutionId, final UUID financialInstitutionUserId, final UUID financialInstitutionAccountId) throws ResourceNotFoundException {
    ...
    @Override
    public List<FinancialInstitutionAccount> getFinancialInstitutionUserAccounts(final UUID financialInstitutionId, final UUID financialInstitutionUserId) throws ResourceNotFoundException {
        try {
    ...
    @Override
    public FinancialInstitutionAccount createFinancialInstitutionAccount(final UUID financialInstitutionId, final UUID financialInstitutionUserId, final FinancialInstitutionAccount financialInstitutionAccount) throws ResourceNotFoundException {
        return create(financialInstitutionId, financialInstitutionUserId, financialInstitutionAccount, null);
    }

    private FinancialInstitutionAccount create(final UUID financialInstitutionId, final UUID financialInstitutionUserId, final FinancialInstitutionAccount financialInstitutionAccount, final UUID idempotency) throws ResourceNotFoundException {
        try {
    ...
    @Override
    public FinancialInstitutionAccount createFinancialInstitutionAccount(final UUID financialInstitutionId, final UUID financialInstitutionUserId, final FinancialInstitutionAccount financialInstitutionAccount, final UUID idempotency) throws ResourceNotFoundException {
        return create(financialInstitutionId, financialInstitutionUserId, financialInstitutionAccount, idempotency);
    }

    @Override
    public void deleteFinancialInstitutionAccount(final UUID financialInstitutionId, final UUID financialInstitutionUserId, final UUID financialInstitutionAccountId) throws ResourceNotFoundException {
        try {
